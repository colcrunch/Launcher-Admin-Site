...
$query = $conn->prepare("SELECT * FROM helparticles WHERE qid= ?");
...
<html lang="en">
 ...
 <div class="container">
   ...
   <h2> Question </h2>
   <form action="includes/answer_edit.php" method="post">
     <div class="row">
       ...
       <div class="row">
         <div class="col-md-12">
           <div class="form-group">
             ...
             <textarea class="form-control" rows="18" name="answer" > <?php echo $results[0]['answer'] ?></textarea>
